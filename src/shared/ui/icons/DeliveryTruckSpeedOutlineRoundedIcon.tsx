...
export interface DeliveryTruckSpeedOutlineRoundedIconProps {
    size?: number
    color?: string
    background?: string
    opacity?: number
...
export const DeliveryTruckSpeedOutlineRoundedIcon: React.FC<DeliveryTruckSpeedOutlineRoundedIconProps> = ({
    size = undefined,
    color = 'currentColor',
...
export default DeliveryTruckSpeedOutlineRoundedIcon
