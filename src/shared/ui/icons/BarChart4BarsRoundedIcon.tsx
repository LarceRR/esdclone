...
export interface BarChart4BarsRoundedIconProps {
    size?: number
    color?: string
    background?: string
    opacity?: number
...
export const BarChart4BarsRoundedIcon: React.FC<BarChart4BarsRoundedIconProps> = ({
    size = undefined,
...
export default BarChart4BarsRoundedIcon
